...
@file  : 003-lstm-birnn-seq2seq-beam-luong.py
...
class Model:
    def __init__(self, size_layer, num_layers, embedded_size, from_dict_size, to_dict_size, batch_size,
...
if __name__ == '__main__':
    ...
    for i in range(epoch):
        ...
        for k in range(0, len(text_to), batch_size):
            ...
            predicted, accuracy, loss, _ = sess.run([tf.argmax(model.training_logits, 2),
                                                     model.accuracy,
