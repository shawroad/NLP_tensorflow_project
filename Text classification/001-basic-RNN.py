...
# print(trainset.target_names)   # ['negative', 'positive']
# print(len(trainset.data))   # 10662
# print(len(trainset.target))  # 10662
# print(trainset.data[:1])   # ['absorbing documentary']
# print(trainset.target[:1])  # [1]
...
class Model:
    ...
    def __init__(self, size_layer, num_layers, embedded_size, dict_size, dimension_output, learning_rate):
        ...
        # 5. 最后一层输出然后连一个全连接层
        self.logits = tf.matmul(outputs[:, -1], W) + b   # 之所以不要最后一行 是因为-1那个是填充的
