...
if __name__ == '__main__':
    ...
    learning_rate = 0.001
# sequence_length, num_classes, vocab_size, batch_size, embedding_size,
    #                  mode, init_size, residual_num, l2_reg_lambda=0.0, dropout_keep_prob=1.0
    # (self, embedding_size, rnn_size, layer_size, vocab_size, attn_size, sequence_length,
    #                  n_classes, batch_size, l2_reg_lambda=0.0)

    model = Model(embedding_size=embedding_size,
    ...
    for epoch in range(epochs):
        ...
        for step in range(total_step):
            ...
            _, loss, acc = sess.run([model.optimizer, model.loss, model.accuracy], feed_dict={
                model.input_x: batch_x, model.input_y: batch_y, model.dropout_keep_prob: 0.5
            })
