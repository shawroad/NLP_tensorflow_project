...
# (self, sequence_length, num_classes, embedding_size, vocab_size,
    ...
    model = Model(sequence_length, num_classes, vocab_size, batch_size, embedding_size,
                  hidden_size, rnn_layer_size, l2_reg_lambda, learning_rate)
    ...
    for epoch in range(epochs):
        ...
        for step in range(total_step):
            ...
            _, loss, acc = sess.run([model.optimizer, model.loss, model.accuracy], feed_dict={
                model.input_x: batch_x, model.input_y: batch_y, model.dropout_rate: 0.2
            })
