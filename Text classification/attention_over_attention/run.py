...
import re
import numpy as np
from Attention_over_Attention import Model
...
if __name__ == '__main__':
    ...
    # size_layer, num_layers, embedded_size, dict_size, num_classes, learning_rate)
    size_layer = 64
    num_layers = 2
    sequence_length= 20
    embedded_size = 128
    ...
    for epoch in range(epochs):
        ...
        for step in range(total_step):
            ...
            _, loss, acc = sess.run([model.optimizer, model.cost, model.accuracy], feed_dict={
                model.input_x: batch_x, model.input_y: batch_y
            })
